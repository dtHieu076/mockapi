    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 flex flex-col h-full hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div className="flex flex-col gap-1">
          ...
          <span className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider w-fit ${
        ...
        <div className="flex items-center gap-1">
          <button 
            ...
            className="text-slate-400 hover:text-primary p-1 rounded-md hover:bg-slate-50 transition-colors"
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-50">
        <div className="flex items-center gap-2 text-slate-500">
          ...
          <span className="text-sm font-bold">{environment.apiCount} APIs</span>
        </div>
        <button 
